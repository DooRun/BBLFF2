...
regionBlackBox  = Region(601,501,573,441)
...
def do_quarter_hour_actions():
    ...
    type("c", Key.CTRL)
    wait(2)
    matchBlackBox = regionBlackBox.exists(Pattern(IMG_BLACKBOX).similar(0.40), 5)
#    matchBlackBox = exists_or_fail(regionBlackBox, IMG_BLACKBOX, "matchBlackBox")
